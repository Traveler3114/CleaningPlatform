...
- **`call_graph.mmd` is misleading.** Contains hundreds of duplicate edges and appears to have been generated by a tool that confused JavaScript module imports with C# dependencies. Actively misleading about the architecture and should be removed.
