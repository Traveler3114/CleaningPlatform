...
public class PagedResultTests
{
    ...
    {
        var result = PagedResult<int>.From([1, 2, 3, 4, 5], 20, 1, 5);
    ...
    {
        var result = PagedResult<int>.From([], 21, 1, 5);
    ...
    {
        var result = PagedResult<int>.From([], 0, 1, 0);
    ...
    {
        var result = PagedResult<int>.From([], 50, 1, 10);
    ...
    {
        var result = PagedResult<int>.From([], 50, 2, 10);
    ...
    {
        var result = PagedResult<int>.From([], 50, 5, 10);
    ...
    {
        var result = PagedResult<int>.From([], 50, 3, 10);
    ...
    {
        var result = PagedResult<int>.From([], 0, 1, 10);
        result.TotalPages.Should().Be(0);
    }
}
