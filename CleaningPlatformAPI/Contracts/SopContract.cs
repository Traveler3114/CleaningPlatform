...
public record BookingSopAssignmentResponse(int Id, int BookingId, int SopTemplateId, string SopName, string? CustomInstructions, int TotalItems, int CompletedItems);
