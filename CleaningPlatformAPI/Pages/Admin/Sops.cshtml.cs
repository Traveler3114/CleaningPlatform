...
public class SopsModel : PageModel
{
    ...
    [BindProperty] public CreateSopTemplateRequest  Template      { get; set; } = new();
    [BindProperty] public UpsertChecklistItemRequest ChecklistItem { get; set; } = new();
    ...
    private async Task LoadAsync(CancellationToken ct)
    {
        ...
        Services  = await _db.ServiceCatalog
            .Where(s => s.IsActive)
            .OrderBy(s => s.Name)
            .ToListAsync(ct);
    }
